    ...
    return (
        <div>
            <div className="flex w-full h-full flex-col md:flex-row">
                <div className="flex p-3 w-full md:w-1/6 bg-secondary-bg-75 flex-col justify-start items-start">
                ...
                <div className="flex p-3 w-full md:w-2/6 bg-secondary-bg-75 flex-col justify-start items-start">
                    <NewsListComponent />
                </div>
            </div>
